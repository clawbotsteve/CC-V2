...
const phyziroPriceIds = {
  ...
  starter: {
    ...
    devMonthly: "plan_basic",
    devQuarterly: "plan_basic_3month",
...
export const planPacks: Record<PlanKey, PlanPack> = {
  Free: {
    ...
    // 2 credits/mo = one trial medium-quality gpt-image-2 generation
    // (medium = 2 credits) OR two low-quality samples (low = 1 credit each).
    creditsPerMonth: 2,
    maxAvatarCount: 0,
    devPriceId: "",
    phyziroPriceId: ""
...
> = {
  plan_free: [
    ...
    { tool: ToolType.VIDEO_GENERATOR, variant: "seedance_v2_ref_5s", creditCost: 38 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "seedance_v2_ref_10s", creditCost: 76 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_480p_5s", creditCost: 40 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_480p_10s", creditCost: 80 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_480p_15s", creditCost: 120 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_720p_5s", creditCost: 75 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_720p_10s", creditCost: 150 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_720p_15s", creditCost: 225 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_1080p_5s", creditCost: 120 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_1080p_10s", creditCost: 240 },
    { tool: ToolType.VIDEO_GENERATOR, variant: "wavespeed_talk_1080p_15s", creditCost: 360 },
