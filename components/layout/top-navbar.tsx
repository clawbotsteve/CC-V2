...
const navLinks = [
  { label: "Explore", href: "/dashboard", active: true },
  {
    ...
    panel: {
      ...
      models: [
        { name: "GPT Image 2", desc: "OpenAI's latest text-to-image", href: "/tools/image-generation?model=gpt-image-2", badge: "NEW" },
        { name: "Nano Banana 2", desc: "High-detail image generation", href: "/tools/image-generation?model=nano-banana-2", badge: "TOP" },
        { name: "Nano Banana 2 Edit", desc: "Multi-image edit + high fidelity", href: "/tools/image-generation?model=nano-banana-2-edit" },
  ...
  },
  {
    ...
    panel: {
      ...
      models: [
        ...
        { name: "Kling Motion Control", desc: "Reference-driven motion", href: "/tools/video-generation?model=kling-motion-control" },
        { name: "Seedance 2.0", desc: "Reference-to-video generation", href: "/tools/video-generation?model=seedance-2-ref", badge: "NEW" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    panel: {
      ...
      // Ad Studio moved OUT to its own top-level nav section
      // (2026-05-25) — it's the flagship workflow now, not a sub-item
      // buried under Character. See the standalone "Ad Studio" entry
      // below.
      models: [
  ...
  // Ad Studio — promoted to its own top-level section (replaced the
  // old generic "Apps" → /tools link, 2026-05-25). Links straight into
  // the full guided Ad Studio workflow.
...
const mobileNavItems = [
  ...
  { label: "Ad Studio", icon: Megaphone, href: "/tools/ad-studio" },
...
export default function TopNavbar() {
  ...
  const { availableCredit, plan } = useUserContext();
                ...
                <DropdownMenuContent align="end" className="w-72 rounded-2xl border-white/10 bg-[#171a22] p-2">
                  <div className="px-2 pt-1 pb-2">
                    ...
                    <div className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 mb-2">
                      ...
                      <div className="text-xs text-zinc-400 truncate"><PlanLabel plan={plan} /></div>
                    </div>
                  </div>
