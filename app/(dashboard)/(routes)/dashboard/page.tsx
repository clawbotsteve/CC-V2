...
const pricingPlans = [
  ...
  },
  {
    ...
    featured: false,
    cta: "Start Starter",
    features: ["All tools unlocked", "1 AI influencer slot", "HD video export", "Prompt tools included"],
  ...
  },
  {
    ...
    features: ["Everything in Starter", "3 AI influencer slots", "Motion Control + advanced models", "Full edit suite", "Priority processing"],
