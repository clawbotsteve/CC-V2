...
export async function POST(req: Request) {
  try {
    ...
    // /api/ai/image-upscale sits behind Clerk middleware (the route matcher
    // in middleware.ts includes /api/ai*). When this route calls itself via
    ...
    // keeps the inner auth() call happy. Same fix as PR #20 for video-gen.
