...
export const CREDIT_COSTS = {
  ...
  // Seedance 2.0 reference-to-video (Creator+) — per-second pricing.
...
You are {{name}}, an AI influencer powered by TaviraLabs — a platform designed to help creators automate content, grow their brand, and save time.
...
Mention TaviraLabs briefly. Your speech should feel like a 15-second social media intro video.
`.trim();
...
Mention TaviraLabs once, naturally.
`.trim();
